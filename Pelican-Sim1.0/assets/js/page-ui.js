...
export function initPageUI() {
  ...
  const workflows = {
    ...
    selection: {
      ...
      scale: 100,
      unit: "%",
      rows: [["Single sample", 43.2], ["Random-of-10", 43.5], ["VLM-direct", 48.7], ["Ctrl-World", 52.3], ["Pelican-Sim 1.0", 63.8]],
    ...
    learning: {
      ...
      scale: 100,
      unit: "%",
      rows: [["Initial SFT", 62.7], ["Iter-SFT", 67.0], ["GRPO · terminal only", 68.5], ["Pelican-Sim 1.0 · full GRPO", 75.4]],
...
function renderDataColumns(rows) {
  ...
  return `<svg class="data-column-chart" viewBox="0 0 520 330" role="img" aria-label="Table 9: original-only versus Pelican-Sim augmentation success. At 10 originals: 28.5 versus 64.5 percent; at 30: 57.0 versus 87.0; at 50: 70.0 versus 93.0.">
    <g class="column-legend"><rect x="55" y="8" width="12" height="12" rx="2" fill="#a9b5c5"/><text x="74" y="19">Original only</text><rect x="230" y="8" width="12" height="12" rx="2" fill="#2563eb"/><text x="249" y="19">Original + Pelican-Sim 1.0</text></g>
