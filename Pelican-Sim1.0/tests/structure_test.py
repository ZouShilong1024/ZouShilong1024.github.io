...
class StructureTests(unittest.TestCase):
    ...
    def test_tabs_have_valid_targets_and_one_initial_selection(self):
        ...
        for key, expected in [("data-tab", ["reverse", "scene", "embodiment", "object", "viewpoint"]),
            ...
            self.assertEqual([a[key] for a in tabs if a.get("aria-selected") == "true"],
                             ["scene" if key == "data-tab" else "data"])
            for tab in tabs:
